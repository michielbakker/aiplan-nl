...
const Article = () => {
	return (
		<ArticleLayout
			title="AI vraagt om politieke keuzes – nu"
			eyebrow="Open Brief"
			meta={
				<div className="space-y-2 text-slate-600">
					<p>
						...
						,{' '}
						<a href="https://linkedin.com/in/reneefrissen" target="_blank" rel="noopener noreferrer" className="font-medium text-slate-700 underline decoration-slate-300 underline-offset-4 hover:text-slate-900">
							Renée Frissen
						</a>{' '}
						en{' '}
						<a href="https://www.stanvanbaarsen.nl" target="_blank" rel="noopener noreferrer" className="font-medium text-slate-700 underline decoration-slate-300 underline-offset-4 hover:text-slate-900">
							Stan van Baarsen
						</a>
						. Eerder verschenen in{' '}
						<a href="https://www.volkskrant.nl/columns-opinie/opinie-voorkom-dat-nederland-een-digitale-kolonie-wordt-en-investeer-meer-in-ai~bcdaf33a/" target="_blank" rel="noopener noreferrer" className="font-medium text-slate-700 underline decoration-slate-300 underline-offset-4 hover:text-slate-900">
							de Volkskrant
						</a>
						.
					</p>
					<p className="font-medium text-slate-500">8 juli 2025</p>
				</div>
			}
			headerAppend={
				<Button
